...
class MsgSupp {
	...
	static ErrorId JsonNotEnabled;
	static ErrorId JsonSerializationFailed;
	...
	static ErrorId OptionServerSizeRCS;
	static ErrorId OptionRestrictOnly;
	static ErrorId OptionExpandOnly;
